...
def ensembleEOFandKMEANS(dir_OUTPUT,dir_PYtool,name_outputs,varunits,numpcs,perc,numclus):
    '''
    '''
...
if __name__ == '__main__':
    ...
    dir_PYtool    = sys.argv[2]  # CLUS_tool DIRECTORY
    ...
    from readNetCDF import read_N_2Dfields
    ...
    ensembleEOFandKMEANS(dir_OUTPUT,dir_PYtool,name_outputs,varunits,numpcs,perc,numclus)
